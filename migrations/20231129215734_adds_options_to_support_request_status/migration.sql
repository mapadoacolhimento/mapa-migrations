/*
  ...
  - The values [finished] on the enum `support_requests_status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "match"."support_requests_status_new" AS ENUM ('open', 'matched', 'social_assistant', 'public_service', 'concluded', 'duplicated', 'old');

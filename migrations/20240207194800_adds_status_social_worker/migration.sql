/*
  ...
  - The values [social_assistant] on the enum `support_requests_status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "match"."support_requests_status_new" AS ENUM ('open', 'matched', 'social_worker', 'public_service', 'duplicated', 'closed', 'special_case');
